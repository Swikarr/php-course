...
<!-- The top portion Google/ Fb and info -->
...
<div class="banner-top">
			...
			<div class="contact-bnr-w3-agile">
				<ul>
					<li><i class="fa fa-envelope" aria-hidden="true"></i><a href="mailto:info@example.com">INFO@VARDANI.COM</a></li>
					<li><i class="fa fa-phone" aria-hidden="true"></i>(+977) 98 63 811 379</li>	
					<li class="s-bar">
						<div class="search">
